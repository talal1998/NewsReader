...
/**
 * Class that displays business news within a fragment
 * @author 956013
 */

class BusinessNewsFragment :Fragment(R.layout.fragment_business) {
    lateinit var viewModel: NewsViewModel
    lateinit var articleAdapter: ArticleAdapter

    val TAG = "BusinessNewsFragment"
    ...
    /** functions to hide and show a progress bar */
    private fun hideProgressBar() {
        paginationProgressBarBusiness.visibility = View.INVISIBLE
    }

    private fun showProgressBar() {
        paginationProgressBarBusiness.visibility = View.VISIBLE
    }
